#ifndef MY_BIG_NUMBER_REV_H
#define MY_BIG_NUMBER_REV_H

#include <iostream>
#include <algorithm>
#include <string>

class MyBigNumberRev {
public:
    MyBigNumberRev(bool enableLogging = true, std::ostream& logStream = defaultLogStream());
